...
def guardar_en_excel():
    ...
    try:
        peso_inicial_f = float(peso_inicial)
        peso_post_f    = float(peso_post)
        muestras_f     = float(muestras) if muestras else 0.0
    except ValueError:
...
app.title("PRELIMINARES + RECIBO (LOCAL)")
...
ttk.Label(app, text="PRELIMINARES", bootstyle=PRIMARY, font=("Calibri", 18, "bold")).grid(row=0, column=0, columnspan=3, pady=10)

ttk.Label(app, text="Número de ENTREGA:", font=("Calibri", 14, "bold")).grid(row=1, column=0, padx=5, pady=5, sticky="e")
entry_entrega = ttk.Entry(app, font=("Calibri", 14))
entry_entrega.grid(row=1, column=1, padx=5, pady=5)
ttk.Button(app, text="GUARDAR ENTREGA", command=guardar_entrega, bootstyle=SUCCESS).grid(row=1, column=2, padx=5, pady=5)

ttk.Label(app, text="Proveedor:", font=("Calibri", 14, "bold")).grid(row=2, column=0, padx=5, pady=5, sticky="e")
combo_proveedor = ttk.Combobox(app, values=["Cargando..."], width=40, font=("Calibri", 14), state="disabled")
...
ttk.Label(app, text="Peso inicial (grs):", font=("Calibri", 14, "bold")).grid(row=3, column=0, padx=5, pady=5, sticky="e")
entry_peso_inicial = ttk.Entry(app, font=("Calibri", 14), state="disabled")
entry_peso_inicial.grid(row=3, column=1, padx=5, pady=5)

ttk.Label(app, text="Peso post fundición (grs):", font=("Calibri", 14, "bold")).grid(row=4, column=0, padx=5, pady=5, sticky="e")
entry_peso_post = ttk.Entry(app, font=("Calibri", 14), state="disabled")
entry_peso_post.grid(row=4, column=1, padx=5, pady=5)

ttk.Label(app, text="Muestras:", font=("Calibri", 14, "bold")).grid(row=5, column=0, padx=5, pady=5, sticky="e")
entry_muestras = ttk.Entry(app, font=("Calibri", 14), state="disabled")
entry_muestras.grid(row=5, column=1, padx=5, pady=5)

# Botones
btn_agregar = ttk.Button(app, text="AGREGAR SOCIEDAD", command=guardar_en_excel, bootstyle=INFO, state="disabled")
btn_agregar.grid(row=6, column=0, pady=20)

btn_guardar_excel = ttk.Button(app, text="💾 Guardar", command=guardar_en_excel, bootstyle=PRIMARY, state="disabled")
btn_guardar_excel.grid(row=6, column=1, pady=20)

btn_generar = ttk.Button(app, text="Generar PDF PRELIMINARES", command=generar_pdf_preliminares, bootstyle=SUCCESS, state="disabled")
btn_generar.grid(row=6, column=2, pady=20)
